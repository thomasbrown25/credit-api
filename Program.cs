...
services.AddCors(options =>
{
    options.AddPolicy(
        ...
        {
            builder
                .WithOrigins("http://localhost:3000", "https://localhost:3000", "http://localhost:5000", "https://localhost:5000", "https://financing-app.azurewebsites.net", "https://money-clarity.azurewebsites.net")
                .AllowAnyHeader()
                .AllowAnyMethod();
        }
    );
